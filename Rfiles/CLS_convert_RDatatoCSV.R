...
#==================================================================
# INPUT NEEDED:
setwd("/media/sf_VBox_Shared/London/raw/next161") #("D:/sharedfolder/first5") #<= the folder in which there is a folder named output_...
...
ufn = unique(dir(paste0("output_",studyname,"/meta/raw")))
